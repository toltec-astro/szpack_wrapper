...
def compute_3d_batch(xo, Dtau, Te, betac, muc, betao, muo, eps_Int=1.0e-4):
    return _SZpack.compute_3d_batch(xo, Dtau, Te, betac, muc, betao, muo, eps_Int)
...
def compute_combo_means_batch(xo, tau, TeSZ, betac_para, omega1, sigma, kappa, betac2_perp):
    return _SZpack.compute_combo_means_batch(xo, tau, TeSZ, betac_para, omega1, sigma, kappa, betac2_perp)
